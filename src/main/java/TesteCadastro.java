...
public class TesteCadastro {
	...
	public void deveRealizarCasdastroComSucesso() {		
		...
		driver.findElement(By.id("elementosForm:sobrenome")).sendKeys("Godinho");
		...
		Assert.assertTrue(driver.findElement(By.id("descNome")).getText().endsWith("Felipe"));
		Assert.assertEquals("Sobrenome: Godinho", driver.findElement(By.id("descSobrenome")).getText());
